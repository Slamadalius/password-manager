...
function getAccounts (masterPassword){
   var enAccounts = storage.getItemSync('accounts');
   var accounts = [];
   
   if (typeof enAccounts !== 'undefined'){
      var bytes = crypto.AES.decrypt(enAccounts, masterPassword);
...
function saveAccounts (accounts, masterPassword){
   var enAccounts = crypto.AES.encrypt(JSON.stringify(accounts), masterPassword);
   
   storage.setItemSync('accounts', enAccounts.toString());
